/**
 * Brand Template Settings — Enterprise Branding
  ...
  if (!isEnterprise) {
    return (
      <div className="space-y-4">
        <h1 className="text-2xl font-bold text-white">Brand Templates</h1>
        <div className="rounded-lg border border-white/10 bg-white/5 p-8 text-center">
          <p className="text-white/60 mb-4">Custom branding is available on the Enterprise plan.</p>
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-white/50">
        Customize document output with your company branding.
      </p>
