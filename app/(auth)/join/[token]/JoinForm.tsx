...
export function JoinForm({ token, invitationId, companyId, role }: JoinFormProps) {
    ...
    return (
      <div className="space-y-4 text-center">
        <div className="rounded-lg border border-green-500/30 bg-green-500/10 px-4 py-4 text-sm text-green-600 dark:text-green-400">
          Check your email to confirm your account. Once confirmed, you&apos;ll be linked to your team automatically.
        </div>
