...
function formatDeadline(deadline: string | null): { label: string; urgency: string } {
  ...
  if (diffDays < 0) {
    ...
    return {
      ...
      urgency: 'text-red-600 dark:text-red-400',
    }
  }
  ...
  if (diffDays === 1) {
    return { label: '1 day left', urgency: 'text-amber-600 dark:text-amber-400' }
  }

  if (diffDays <= 3) {
    return { label: `${diffDays} days left`, urgency: 'text-amber-600 dark:text-amber-400' }
  }

  if (diffDays <= 7) {
    return { label: `${diffDays} days left`, urgency: 'text-yellow-700 dark:text-yellow-300' }
  }
