  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <h3 className="font-semibold text-white">Compliance Gap Report</h3>
      ...
      <div className="grid grid-cols-4 gap-3">
        <div className="rounded-lg border border-gray-800 bg-gray-900/50 p-3 text-center">
          <p className="text-lg font-semibold text-white">{report.totalRequirements}</p>
        ...
        <div className="rounded-lg border border-yellow-900/50 bg-yellow-900/10 p-3 text-center">
          ...
          <p className="text-xs text-gray-500">Empty Sections</p>
        </div>
        <div className="rounded-lg border border-gray-700 bg-gray-800/30 p-3 text-center">
          <p className="text-lg font-semibold text-gray-400">{summary.orphanSections}</p>
          <p className="text-xs text-gray-500">Orphan Sections</p>
        </div>
      </div>
